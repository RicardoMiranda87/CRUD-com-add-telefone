...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { numero: @contato.numero, tipo: @contato.tipo, user_id: @contato.user_id } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { numero: @contato.numero, tipo: @contato.tipo, user_id: @contato.user_id } }
